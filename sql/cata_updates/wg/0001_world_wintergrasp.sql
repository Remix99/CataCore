...
UPDATE `SkyFire_string` SET `content_default` = 'The Wintergrasp fortress has been captured by %s !', `content_loc2` = '%s a captur  la forteresse du Joug d''hiver !' WHERE `SkyFire_string`.`entry` =12072 LIMIT 1 ;
